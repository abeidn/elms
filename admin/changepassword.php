...
$mail=$_SESSION['alogin'];
    $sql ="SELECT Password FROM admin WHERE email=:mail and Password=:password";
...
if($newpassword==$cpassword){
    if($query -> rowCount() > 0)
       {
        $con="update admin set Password=:newpassword where email=:mail";
        $chngpwd1 = $dbh->prepare($con);
        $chngpwd1-> bindParam(':mail', $mail, PDO::PARAM_STR);
